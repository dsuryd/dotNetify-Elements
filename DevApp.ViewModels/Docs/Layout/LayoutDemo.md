...
<if webcomponent>
```jsx
<d-main theme="/* sample theme */">
  <d-header>
      <d-frame nogap="true">
        <d-panel horizontal="true" middle="true">
            <d-panel>
              <a href="#">Subscribe</a>
            </d-panel>
            <h1>Large</h1>
        ...
        <hr />
        <d-panel horizontal="true" apart="true">
            <a href="#">World</a>
            <a href="#">U.S.</a>
            <a href="#">Technology</a>
            <a href="#">Design</a>
  ...
  <d-section>
      <d-frame>
        ...
        <d-panel horizontal="true" gap="2rem">
            <d-panel flex="75%" css="margin-top: 2rem;">
              <article>
                  <h4>From the Firehose</h4>
                  <h2>Sample Blog Post</h2>
                  July 4th, 2018
