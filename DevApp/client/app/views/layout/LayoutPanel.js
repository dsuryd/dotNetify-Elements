...
\`\`\`jsx
<div style="border: 2px dashed gray; height: 16rem">
   <d-panel css="border: 2px dashed red; height: 13rem"${props}>
      ...
      return (
         ...
         >
            {!webComponent ? (
               ...
               <div style={{ border: '2px dashed #ccc', height: '16rem' }}>
                  <d-panel
                     css="border: 2px dashed red; height: 13rem"
