...
Modal.componentTypes.Container.defaultProps = {
  theme: utils.getDefaultTheme()
};
Modal.componentTypes.HeaderContainer.defaultProps = {
  theme: utils.getDefaultTheme()
};
Modal.componentTypes.BodyContainer.defaultProps = {
  theme: utils.getDefaultTheme()
};
Modal.componentTypes.FooterContainer.defaultProps = {
  theme: utils.getDefaultTheme()
};
