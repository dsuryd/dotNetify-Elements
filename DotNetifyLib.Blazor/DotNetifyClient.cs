...
{
   /// <summary>
   /// Defines a dotNetify client for Blazor component.
   /// </summary>
   public interface IDotNetifyClient : Client.IDotNetifyClient
   {
      Task ConnectAsync(string vmId, BlazorComponent component, VMConnectOptions options = null);
   }

   /// <summary>
   /// Provides connection to a dotNetify hub server.
   /// </summary>
   internal class DotNetifyClient : IDotNetifyClient
   {
      ...
      /// <param name="view">Blazor component.</param>
      /// <param name="options">View model initialization options.</param>
      public async Task ConnectAsync(string vmId, BlazorComponent component, VMConnectOptions options = null)
      {
         await ConnectAsync(vmId, new ViewState(component), options);
      }
