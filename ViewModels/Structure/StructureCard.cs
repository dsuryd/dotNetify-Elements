...
namespace dotNetify_Elements
{
   public class StructureCard : BaseVM
   {
      ...
      {
         var markdown = new Markdown("dotNetify_Elements.Docs.Structure.Card.md");
   ...
   public class CardImageExample : BaseVM
   {
      ...
      {
         var image = Utils.GetResourceAsBytes("dotNetify_Elements.Docs.Structure.card_image_example.jpg");
